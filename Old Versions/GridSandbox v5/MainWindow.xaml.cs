...
namespace GridSandbox
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        void highScore()
        {
          //  highestScore = int.TryParse(File.ReadAllLines("\\highscore.txt"));
        }
        ...
        void difficulty()
        {
            ...
            else if (countTime > 490 && countTime < 580)
            {
                level = 10;
            }
